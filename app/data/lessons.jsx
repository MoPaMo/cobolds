const lessons = [
  {
    ...
    slug: "introduction-to-cobol",
    description:
      "Dive into COBOL and discover why it's still a key player today.",
    duration: "1 hour",
    ...
    text: (
      <>
        ...
        <p>
          COBOL (Common Business-Oriented Language) is a classic programming
          language that's been around for decades. It was created mainly for
          business, finance, and administrative tasks, and it's still powering
          many legacy systems in large organizations today.
        </p>
        <p>
          In this lesson, we'll journey through the history of COBOL, highlight
          its standout features, and explore why it remains relevant in today's
          tech landscape.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>A COBOL program is organized into four main sections:</p>
        <ol>
        ...
        <p>
          Each section has its own role, handling things like program info,
          environment settings, data definitions, and the actual code
          instructions.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          The Identification Division is where you provide key details about
          your COBOL program, like its name and who wrote it. It's the first
          section in any COBOL program.
        </p>
        <p>Example:</p>
        <pre>
          {`
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          The Environment Division sets up the program's environment, like which
          devices to use for input and output or how to handle file
          configurations.
        </p>
        <p>Example:</p>
        <pre>
  ...
  },
  {
    ...
    text: (
      <>
        <h1>Data Division</h1>
        <p>
          The Data Division is where you define all the data your program will
          use. It includes sections like the File Section, Working-Storage
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          The Procedure Division is where your COBOL program comes to life with
          executable instructions. This is where you implement the program's
          logic using various COBOL statements and operations.
        </p>
        <p>Example:</p>
        <pre>
          {`
...
STOP RUN.
  ...
  },
  {
    ...
    slug: "compiling-and-running-cobol-programs",
    ...
    text: (
      <>
        ...
        <p>
          Once you've written your COBOL code, it's time to compile it.
          Compiling transforms your source code into an executable form. In this
          lesson, we'll walk through the basics of compiling and running COBOL
          programs using popular COBOL compilers.
        </p>
        <p>Steps:</p>
        <ol>
          <li>
            Write your COBOL code and save it with a `.cob` or `.cbl` extension.
          </li>
  ...
  },
  {
    ...
    slug: "practicing-basic-cobol-syntax",
    ...
    text: (
      <>
        ...
        <p>
          Practice makes perfect! In this lesson, you'll engage in exercises
          that help you write simple COBOL statements and programs, reinforcing
          your understanding of the syntax.
        </p>
        <p>Exercises:</p>
        <ol>
          <li>Create a COBOL program that displays your name.</li>
          <li>
            Define a variable to store an employee's ID and assign it a value.
          </li>
  ...
  },
  {
    ...
    slug: "working-with-variables-and-data-types",
    description:
      "Deepen your understanding of variables and data types in COBOL.",
    duration: "1.5 hours",
    ...
    text: (
      <>
        ...
        <p>
          Variables are the building blocks for storing and manipulating data in
          your programs. In COBOL, you'll define variables using the PIC clause,
          which specifies their data type and size.
        </p>
        <p>Example:</p>
        <pre>
          {`
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          Control structures shape the flow of your program. In COBOL, you'll
          use IF statements for decision-making and PERFORM statements to create
          loops. These tools help your program respond to different conditions
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          COBOL excels at handling files. You can set up files in the
          Environment Division and perform actions like reading from and writing
          to them in the Procedure Division.
        </p>
        <p>Example:</p>
        <pre>
          {`
...
STOP RUN.
  ...
  },
  {
    ...
    slug: "practicing-file-operations-in-cobol",
    description:
      "Hands-on exercises to practice file input and output in COBOL.",
    duration: "2.5 hours",
    ...
    text: (
      <>
        ...
        <p>
          Strengthen your file handling skills with practical exercises. These
          tasks will help you become adept at managing files within your COBOL
          programs.
        </p>
        <p>Exercises:</p>
        <ol>
          <li>
            Create a COBOL program that reads employee data from a file and
            displays it.
          </li>
          <li>
            Write a program that adds new employee records to an existing file.
          </li>
          <li>
            Develop a program that updates specific records in a file based on
            certain criteria.
          </li>
        </ol>
      </>
  ...
  },
  {
    ...
    slug: "cobol-sorting-and-merging",
    ...
    text: (
      <>
        ...
        <p>
          Organizing data efficiently is crucial. COBOL offers SORT and MERGE
          commands to help you arrange and combine data sets seamlessly.
        </p>
        <p>Example:</p>
        <pre>
          {`
SORT EMPLOYEE-FILE
  ...
  },
  {
    ...
    slug: "practicing-sorting-and-merging-in-cobol",
    description:
      "Hands-on exercises to practice sorting and merging data in COBOL.",
    duration: "2.5 hours",
    ...
    text: (
      <>
        ...
        <p>
          Put your sorting and merging skills to the test with these practical
          exercises. You'll learn how to manage and organize data effectively in
          your COBOL programs.
        </p>
        <p>Exercises:</p>
        <ol>
          <li>
            Write a COBOL program that sorts employee records by their ID.
          </li>
          <li>
            Create a program that merges two sorted employee files into one.
          </li>
          <li>
            Develop a program that sorts employee data by name in descending
            order.
          </li>
        </ol>
      </>
  ...
  },
  {
    ...
    text: (
      <>
        ...
        <p>
          Handling multiple data items is easier with arrays and tables. COBOL
          lets you create these structures to manage collections of similar data
          efficiently.
        </p>
        <p>Example:</p>
        <pre>
